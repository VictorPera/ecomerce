...
export function renderizarCatalogo(){
    for(const produtoCatalogo of catalogo){
        ...
        const cartaoProduto = `
        <div id="card-produto-${produtoCatalogo.id}" class="flex flex-col w-80 m-2 p-2 justify-between shadow-xl shadow-slate-400 rounded-lg group">
            <img 
            ...
            <button id="adicionar-${produtoCatalogo.id}" class="bg-slate-950 text-slate-200 hover:bg-slate-700 duration-200 rounded-lg"><i class="fa-solid fa-cart-plus"></i></button>
        </div>`;
